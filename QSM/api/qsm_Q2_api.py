...
# 加载Q2模型
model = V4Model(vocab_size, 128)
model.load_state_dict(torch.load('/root/.openclaw/workspace/Models/QSM/bin/Q2_quantum_model.pth', map_location='cpu'))
model.eval()
print("Q2量子模型加载成功")
...
def status():
    return jsonify({
        'service': 'QSM Q2 Quantum Model API',
        'model': 'Q2 (V4 pretrained + fine-tuned)',
        'accuracy': '48.60%',
