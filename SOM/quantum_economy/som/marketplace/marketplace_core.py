...
# 导入追溯系统
try:
    from quantum_economy.som.traceability.traceability_system import SomTraceabilitySystem
except ImportError:
    # 开发环境Mock
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("som_marketplace.log"),
