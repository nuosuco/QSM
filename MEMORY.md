...
> 最后更新：2026-07-06 02:10（基线审计v11：qcl_phase2=960行（parse_var三件套修复+2行未提交），有效0x14=298（+1），真正量子电路=79（+2）；其他指标全部一致）
...
| `QCL引导器.qentl` | **472** |
| `src/qcl_phase2.c` | **960**（实测：parse_var 三件套修复+2行，git diff 未提交） |
