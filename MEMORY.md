...
## 项目总进度统计 (2026-07-05)
> 扫描全量 .qentl + .qbc（排除 dotfiles 和空文件；.qbc 代码区用 sp_len(2B LE) 边界识别，DEF/END 仅统计代码区 opcode 0x66/0x67）
...
|------|------|
| 有效 0x14 首字节文件数 | **547** |
| 含量子指令(0x01–0x08)文件数 | **520** |
| 代码区 DEF (0x66) 数 | **1,017** |
| 代码区 END (0x67) 数 | **1,014**（配对率 99.7%，近乎完美） |
| 代码区 DEF+END 总数 | **2,031** |
| 量子指令总数 (0x01–0x08) | **22,148** |
| 代码字节量 | **92,676 字节** |
| 总文件大小 | **187,424 字节 (183.0 KB)** |

### 汇总
| 指标 | 数值 |
|------|------|
| 函数总数 | **1,177**（.qentl def 160 + .qbc DEF 1,017） |
| 量子指令总数 | **24,837**（.qentl关键词 2,689 + .qbc 0x01–0x08 22,148） |
