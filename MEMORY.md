...
|------|------|
| 有效 0x14 首字节文件数 | **467** |
| 含量子指令(0x01–0x08)文件数 | **440** |
| 代码区 DEF (0x66) 数 | **658** |
| 代码区 END (0x67) 数 | **661**（配对率 100.3%，近乎完美） |
| 代码区 DEF+END 总数 | **1,319** |
| 量子指令总数 (0x01–0x08) | **16,334** |
| 代码字节量 | **69,654 字节** |
| 总文件大小 | **160,407 字节 (157.1 KB)** |

### 汇总
| 指标 | 数值 |
|------|------|
| 函数总数 | **821**（.qentl def 163 + .qbc DEF 658） |
| 量子指令总数 | **19,190**（.qentl门引用 2,856 + .qbc 0x01–0x08 16,334） |
