...
# 导入松麦经济模型模块
<<<<<<< HEAD
from quantum_economy.QSM.QSM_economy import SomEconomyModel
=======
from quantum_economy.qsm.qsm_economy import SomEconomyModel
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("qsm_ecommerce.log"),
    ...
    def register_user(self, user_data: Dict) -> Dict:
        ...
        if self.economy_model:
            ...
            if reward_result["success"]:
                self.users[user_id]["qsm_balance"] += reward_result["reward_amount"]
        ...
        return {
            ...
            "user_id": user_id,
            "qsm_balance": self.users[user_id]["qsm_balance"]
        }
    ...
    def pay_order(self, order_id: str, payment_data: Dict) -> Dict:
        ...
        if self.economy_model and user_id:
            ...
            if user_id in self.users:
                self.users[user_id]["qsm_balance"] += reward_amount
                self.users[user_id]["total_spend"] += order["total_amount"]
        
        # 记录奖励信息
        order["qsm_reward"] = reward_amount
