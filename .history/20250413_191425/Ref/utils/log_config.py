...
def get_logger(name, log_file=None, level='info', console=True, file_size=5*1024*1024, backup_count=3):
    """
    获取指定名称的日志记录器
...
def configure_root_logger(log_file='system.log', level='info', console=True):
    """
    配置根日志记录器
