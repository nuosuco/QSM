...
<<<<<<< HEAD
from quantum_economy.SOM.marketplace.api import marketplace_api
from quantum_economy.SOM.marketplace.marketplace_core import SomMarketplace
=======
from quantum_economy.som.marketplace.api import marketplace_api
from quantum_economy.som.marketplace.marketplace_core import SomMarketplace
...
def create_app(test_config=None):
    ...
    # 产品详情页面
    @app.route('/som/marketplace/product/<product_id>')
