...
class SomWallet:
    ...
    def get_balance(self, asset_type: str = "weq_coin") -> float:
        """获取资产余额
    ...
    def deposit(self, amount: float, asset_type: str = "weq_coin", source: str = "external", memo: str = "") -> str:
        """存入资产
    ...
    def withdraw(self, amount: float, asset_type: str = "weq_coin", destination: str = "external", memo: str = "") -> str:
        """提取资产
    ...
    def transfer(self, to_address: str, amount: float, asset_type: str = "weq_coin", memo: str = "") -> str:
        """转账
    ...
    def quantum_transfer(self, asset_qubit: Dict) -> Dict:
        ...
        asset_type = asset_qubit.get("asset_type", "weq_coin")
