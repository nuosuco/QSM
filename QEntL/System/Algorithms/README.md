...
| 算法 | 文件 | 状态 | 测试通过率 | 描述 |
|------|------|------|-----------|------|
| 量子模拟器 | `VM/src/quantum_simulator.py` | ✅ | 100% | 量子比特、量子门、测量 |
| Bell态 | 内置 | ✅ | 100% | 量子纠缠基础 |
| GHZ态 | 内置 | ✅ | 100% | 多粒子纠缠态 |
| 量子门库 | 内置 | ✅ | 100% | H/X/Y/Z/S/T门 |

### 高级量子算法

| 算法 | 文件 | 状态 | 测试通过率 | 描述 |
|------|------|------|-----------|------|
| Grover搜索 | `Algorithms/grover.py` | ✅ | 85% | 量子搜索算法，O(√N)复杂度 |
| QFT | `Algorithms/qft.py` | ✅ | 100% | 量子傅里叶变换 |
| Shor算法 | `Algorithms/shor.py` | ✅ | 75% | 整数分解 |
| 量子隐形传态 | `Algorithms/teleportation.py` | ✅ | 100% | 量子态传输 |

### 自我进化框架

| 模块 | 文件 | 状态 | 测试通过率 | 描述 |
|------|------|------|-----------|------|
| Agent Harness | `AgentHarness/qsm_agent_harness.py` | ✅ | 100% | 自我进化三模块 |
| 量子Agent | `AgentHarness/quantum_agent_harness.py` | ✅ | 100% | 量子虚拟机集成 |
...
```bash
cd /root/QSM
python3 QEntL/System/Algorithms/test_all.py
```
...
```bash
# QFT
python3 QEntL/System/Algorithms/qft.py

# Shor
python3 QEntL/System/Algorithms/shor.py

# 隐形传态
python3 QEntL/System/Algorithms/teleportation.py

# Grover
python3 QEntL/System/Algorithms/grover.py
```
