...
test_run_length_encoding, test_caesar_encrypt, test_vigenere_cipher, test_stack_lifo, test_queue_fifo, test_fibonacci_iterative, test_array_reverse, test_palindrome, test_selection_sort, test_string_dedup, test_kadane_max_subarray, test_binary_search, test_insertion_sort, test_string_find_substring,
