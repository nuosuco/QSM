...
test_extract_digits,
test_leap_year, test_digital_root, test_matrix_multiply, test_anagram_check, test_caesar_decrypt, test_count_vowels, test_run_length_encoding, test_caesar_encrypt, test_vigenere_cipher, test_stack_lifo, test_queue_fifo, test_fibonacci_iterative, test_array_reverse, test_palindrome, test_selection_sort,
