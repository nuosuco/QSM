...
| 目录 | 含义 | 当前状态 | 位置 |
|------|------|----------|------|
| **QEntl** | 实际运行版本 | 空着（还没有真正服务用户） | /root/QSM/QEntl/ |
| **QLife** | 生长版本 | v0.0.3在生长中，Web操作系统桌面绑定在这里测试 | /root/QSM/QLife/v0.0.3/ |
| **QSM** | 所有历史版本 | v0.0.1 + v0.0.2，以后一起通过量子纠缠通信与量子态传送构建成QSM | /root/QSM/QSM/ |
| **root** | 用户自己的数据 | 空着，用QDFS构建 | /root/QSM/root/ |
| **Q** | 应用商店 | 空着，QSM的应用=完整的自举生长的QEntl全栈量子操作系统 | /root/QSM/Q/ |
| **OS** | 三种部署安装程序 | 空着（如终端安装程序） | /root/QSM/OS/ |
| **docs** | 文档中心 | 现有文档 | /root/QSM/docs/ |
