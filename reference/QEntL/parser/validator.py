...
class QEntLValidator:
    ...
    def _validate_references(self, data: Dict[str, Any], errors: List[str]) -> None:
        """验证引用的ID是否存在"""
        # 网络中节点和通道引用的验证
    ...
    def validate_file(self, parsed_file_path: str) -> Tuple[bool, List[str]]:
        """
        验证解析后的QEntL JSON文件
    ...
    def validate_and_report(self, data: Dict[str, Any]) -> None:
        """
        验证数据并打印报告
