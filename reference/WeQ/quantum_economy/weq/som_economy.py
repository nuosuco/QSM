...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("weq_economy.log"),
...
class SomEconomyModel:
    ...
    def create_weq_coin(self, amount: float, recipient_id: str) -> Optional[QuantumAsset]:
        """创建松麦币
        ...
        # 分配给松麦链
        if self.chain:
            weq_coin.assign_to_chain(self.chain.chain_id)
        
        # 更新总发行量
        self.value_distributor.update_total_supply(amount)
        
        logger.info(f"创建松麦币: {weq_coin.asset_id}, 数量: {amount}, 接收者: {recipient_id}")
        return weq_coin
    ...
    def process_organic_purchase(self, user_id: str, product_id: str, purchase_amount: float) -> Dict:
        ...
        # 创建松麦币
        weq_coin = self.create_weq_coin(reward_amount, user_id)
        ...
        purchase_tx_data = {
            ...
            "reward_asset_id": weq_coin.asset_id,
    ...
    def register_new_user(self, user_id: str, user_data: Dict) -> Dict:
        ...
        # 创建松麦币
        weq_coin = self.create_weq_coin(initial_reward, user_id)
...
class ValueDistributor:
    ...
    def distribute_value(self, economy_model: SomEconomyModel, distribution_data: Dict) -> bool:
        ...
        for recipient in distribution_data["recipients"]:
            ...
            # 创建松麦币
            weq_coin = economy_model.create_weq_coin(amount, user_id)
