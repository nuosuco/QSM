...
# 导入追溯系统
try:
    from quantum_economy.ref.traceability.traceability_system import SomTraceabilitySystem
except ImportError:
    # 开发环境Mock
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("ref_marketplace.log"),
